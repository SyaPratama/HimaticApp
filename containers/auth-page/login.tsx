  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-[5%] pt-[100px] pb-16 bg-mono-900">
      <div className="w-full max-w-md bg-mono-800 border border-mono-700 rounded-3xl p-10">
        <h2 className="font-extrabold text-mono-100 text-[1.8rem] mb-1">
          Masuk
        </h2>
        <p className="text-mono-300 text-sm mb-6">
        ...
        <label className="block text-xs font-semibold text-mono-100 mb-1.5">
          Email
        </label>
        ...
        <input
          type="password"
          className="w-full bg-mono-900 border border-mono-700 rounded-md px-3 py-2 text-mono-100 mb-6"
        />
